...
df = pd.read_csv('/Users/ryles/Desktop/commentaires.csv')
 
best_logistic_regression_model = load('/Users/ryles/saved_allocine.joblib') 
vectorizer = load('/Users/ryles/saved_allocine_vect.joblib')
...
if page == pages[0]:
    ...
    st.image('/Users/ryles/Downloads/efrei_paris.jpg')
